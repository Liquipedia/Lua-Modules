...
function CustomHiddenDataBox.addCustomVariables(args, queryResult)
	...
	if Logic.readBool(args.storage) then
		...
		local lpdbData = {
			...
			startdate = Variables.varDefault('tournament_startdate', '0000-01-01'),
			enddate = Variables.varDefault('tournament_enddate', '0000-01-01'),
			sortdate = Variables.varDefault('tournament_enddate', '0000-01-01'),
