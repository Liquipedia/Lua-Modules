...
function CustomMatchGroupInput._processPlayerMapData(player, map, opponentIndex, playerIndex)
	local getCharacterName = FnUtil.curry(MatchGroupInput.getCharacterName, CharacterStandardization)

	local character = getCharacterName(map['o' .. opponentIndex .. 'p' .. playerIndex])
