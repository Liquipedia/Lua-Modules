...
function CustomMatchSummary._createMapRow(game)
	...
	local leftNode = mw.html.create('div')
		...
		:node(DisplayHelper.MapScore(
			game.scores[1] and game.scores[1] .. (game.extradata.points1 and ' (' .. game.extradata.points1 .. ')' or ''),
	...
	local rightNode = mw.html.create('div')
		:addClass('brkts-popup-spaced')
		:node(DisplayHelper.MapScore(
			game.scores[2] and game.scores[2] .. (game.extradata.points2 and ' (' .. game.extradata.points2 .. ')' or ''),
