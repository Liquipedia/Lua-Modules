...
---@class StormgateMatchSummarySubmatchCollapsible
---@operator call: StormgateMatchSummarySubmatchCollapsible
---@field root Html
---@field table Html
...
function CustomMatchSummary.getByMatchId(args)
	...
	if match.isFfa then
		error('FFA is not yet supported in stormgate match2')
