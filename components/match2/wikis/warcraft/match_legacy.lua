...
function p.storeSoloMatchSMW(match, match2)
	...
	mw.smw.subobject({
		...
		'has match youtube=' .. (streams.youtube or ''),
		'has best of=' .. (extradata.bestof or ''),
		'has player left first hero=' .. (extradata.player1hero1 or ''),
		'has player left second hero=' .. (extradata.player1hero2 or ''),
		'has player left third hero=' .. (extradata.player1hero3 or ''),
		'has player right first hero=' .. (extradata.player2hero1 or ''),
		'has player right second hero=' .. (extradata.player2hero2 or ''),
		'has player right third hero=' .. (extradata.player2hero3 or ''),
	})
end
