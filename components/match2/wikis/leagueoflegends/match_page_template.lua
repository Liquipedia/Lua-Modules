			...
			{{^isBestOfOne}}<div class="match-bm-lol-game-overview">
				<div class="match-bm-lol-game-summary">
					...
					<div class="match-bm-lol-game-summary-center">
						<div class="match-bm-lol-game-summary-faction">{{#teams.1.side}}[[File:Lol faction {{teams.1.side}}.png|link=|{{side}} side]]{{/teams.1.side}}</div>
						...
						<div class="match-bm-lol-game-summary-faction">{{#teams.2.side}}[[File:Lol faction {{teams.2.side}}.png|link=|{{side}} side]]{{/teams.2.side}}</div>
					</div>
