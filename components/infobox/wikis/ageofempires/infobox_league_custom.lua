...
function CustomLeague:defineCustomPageVariables(args)
	...
	Variables.varDefine('tournament_date', (not String.isEmpty(args.date)) and ReferenceCleaner.clean(args.date)
											or ReferenceCleaner.clean(args.edate))
	Variables.varDefine('tournament_sdate', (not String.isEmpty(args.sdate)) and ReferenceCleaner.clean(args.sdate)
