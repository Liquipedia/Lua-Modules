...
describe('DateRange Widget', function()
	...
	it('should return "date-range-different-months-unknown-days-and-end-month" if endDate and startDay is missing', function()
	...
	it('should return "date-range-different-months-unknown-days" if both days are unknown and in different months', function()
