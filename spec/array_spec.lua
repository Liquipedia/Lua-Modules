...
describe('array', function()
	...
	describe('ParseCommaSeparatedString', function()
		it('plain', function()
			...
			assert.are_same(a, Array.parseCommaSeparatedString('test1 - test2-test3', '-'))
			assert.are_same(a, Array.parseCommaSeparatedString('test1 - test2-test3', '-', false))
		end)
		it('pattern toogle', function ()
			assert.are_same({'test1-test2,test3&'}, Array.parseCommaSeparatedString('test1-test2,test3&', 'test%d'))
			assert.are_same({'test1-test2,test3&'}, Array.parseCommaSeparatedString('test1-test2,test3&', 'test%d', false))
			assert.are_same({'', '-', ',', '&'}, Array.parseCommaSeparatedString('test1-test2,test3&', 'test%d', true))
		end)
	end)
end)
