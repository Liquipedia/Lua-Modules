...
describe('hidden data box', function()
	...
	describe('test fetching and wiki var storing', function()
		...
		it('player wiki variables are correctly set', function()
			...
			assert.are_equal('Xy_G', Variables.varDefault('buteo_esports_p5'))
			assert.are_equal('xy_G', Variables.varDefault('buteo_esports_p5dn'))
			assert.are_equal('Germany', Variables.varDefault('buteo_esports_p5flag'))
		end)
	end)
end)
