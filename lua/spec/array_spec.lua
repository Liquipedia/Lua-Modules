...
describe('array', function()
	...
	describe('isArray', function()
		...
		it('Arrays are array', function()
			...
			assert.is_true(Array.isArray{5, nil, 3})
		end)
		it('Tables are array', function()
			assert.is_false(Array.isArray{a = 1, [3] = 2, c = 3})
			assert.is_false(Array.isArray{5, 2, c = 3})
		end)
		it('Arrays can not have indexes below 1', function()
			assert.is_false(Array.isArray{5, 2, [-1] = 3})
			assert.is_false(Array.isArray{5, 2, [0] = 3})
		end)
	end)
