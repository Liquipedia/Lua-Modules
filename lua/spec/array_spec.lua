...
describe('array', function()
	...
	describe('isArrayWithGaps', function()
		it('Empty table is array with gaps', function()
			assert.is_true(Array.isArrayWithGaps{})
		end)
		it('Arrays are array', function()
			assert.is_true(Array.isArrayWithGaps{5, 2, 3})
			assert.is_true(Array.isArrayWithGaps{5, nil, 3})
		end)
		it('Tables are array', function()
			assert.is_false(Array.isArrayWithGaps{a = 1, [3] = 2, c = 3})
			assert.is_false(Array.isArrayWithGaps{5, 2, c = 3})
		end)
		it('Lua Arrays have indexes > 0', function()
			assert.is_false(Array.isArrayWithGaps{5, 2, [-1] = 3})
			assert.is_false(Array.isArrayWithGaps{5, 2, [0] = 3})
		end)
	end)
