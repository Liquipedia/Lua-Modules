...
describe('Variables', function()
	...
	describe('varExists', function()
		it('verify', function()
			Variables.varDefine('foo_bar', 'hello world')
			assert.is_true(Variables.varExists('foo_bar'))
			Variables.varDefine('foo_bar', '')
			assert.is_false(Variables.varExists('foo_bar'))
			assert.is_false(Variables.varExists('foo_no_bar'))
		end)
	end)
end)
