...
describe('Date', function()
	...
	describe('calculate age', function()
		it('verify', function()
			assert.are_equal(24, DateExt.calculateAge('2025-10-01', '2001-01-01'))
			assert.are_equal(21, DateExt.calculateAge('2025-03-01', '2004-02-29'))
			assert.are_equal(20, DateExt.calculateAge('2025-02-28', '2004-02-29'))
			assert.are_equal(18, DateExt.calculateAge('2020-02-29', '2001-10-31'))
		end)
	end)
end)
