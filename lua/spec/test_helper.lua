...
return function(busted, helper, options)
	...
	local function SetActiveWiki(wiki)
		...
		if wiki ~= '' then
			...
			table.insert(paths, 'wikis/'.. wiki ..'/info/?.lua')
			table.insert(paths, 'wikis/'.. wiki ..'/highlight_conditions/?.lua')
			table.insert(paths, 'wikis/'.. wiki ..'/region/?.lua')
			table.insert(paths, 'wikis/'.. wiki ..'/tier/?.lua')
		end
		table.insert(paths, 'wikis/commons/factions/?.lua')
		table.insert(paths, 'wikis/commons/factions/starcraft_starcraft2/?.lua')
		table.insert(paths, 'wikis/commons/factions/?.lua')
		...
		table.insert(paths, 'wikis/commons/standard/info/?.lua')
		table.insert(paths, 'wikis/commons/standard/highlight_conditions/?.lua')
		table.insert(paths, 'wikis/commons/standard/region/?.lua')
		table.insert(paths, 'wikis/commons/standard/links/?.lua')
		table.insert(paths, 'wikis/commons/standard/tier/?.lua')
