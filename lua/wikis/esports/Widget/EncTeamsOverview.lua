---
-- @Liquipedia
-- page=Module:Widget/EncTeamsOverview
--
...
---@class EncTeamsOverview: Widget
---@operator call(table): EncTeamsOverview
local EncTeamsOverview = Class.new(Widget)
...
---@return Widget
function EncTeamsOverview:render()
		...
		children = WidgetUtil.collect(
			HtmlWidgets.Tr{
				children = WidgetUtil.collect(
					...
					HtmlWidgets.Th{children = HtmlWidgets.Abbr{title = 'Qualified to X/16 Tournaments', children = 'Q#'}},
			...
			Array.map(clubs, function(club)
				return HtmlWidgets.Tr{
					children = WidgetUtil.collect(
						...
						HtmlWidgets.Td{children = club.club and Template.safeExpand(mw.getCurrentFrame(), 'LeagueIconSmall/enc') or nil},
