...
local CONTENT = {
	...
	specialEvents = {
		noPanel = true,
		body = '{{Liquipedia:Splitgate Pro Series}}',
...
return {
	banner = {
		lightmode = 'Splitgate 2021 full lightmode.png',
		darkmode = 'Splitgate 2021 full darkmode.png',
	},
	metadesc = 'Comprehensive Splitgate wiki with articles covering everything from weapons, maps and modes' ..
		'to strategies, to tournaments, to competitive players and teams.',
	title = 'Splitgate',
	navigation = {
		{
			file = 'WuTum at the 2024 Arlington Major.jpg',
			title = 'Players',
			link = 'Portal:Players',
			count = {
				method = 'LPDB',
		...
		{
			file = 'T1 Faker at Worlds 2022.jpg',
			title = 'Teams',
			link = 'Portal:Teams',
			count = {
				method = 'LPDB',
		...
		{
			file = 'Splitgate Pro Series banner.png',
			title = 'Tournaments',
		...
		{
			file = 'Splitgate Battle_Rifle.png',
			title = 'Weapons',
			link = 'Portal:Weapons',
		},
		{
			file = 'Splitgate Crag Map Splash.png',
			title = 'Maps',
			link = 'Portal:Maps',
		},
	},
