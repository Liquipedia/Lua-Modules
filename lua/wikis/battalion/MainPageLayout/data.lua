...
return {
	banner = {
		lightmode = 'Battalion 1944 full lightmode.png',
		darkmode = 'Battalion 1944 full darkmode.png',
	},
	metadesc = 'The Battalion 1944 esports wiki covering everything from players, teams and transfers, ' ..
		'to tournaments and results, champions, and maps.',
	title = 'Battalion 1944',
	navigation = {
		{
			file = 'SectorOne_Victory2019.jpg',
			title = 'Teams',
			link = 'Portal:Teams',
			count = {
				method = 'LPDB',
		...
		{
			file = 'MaxStrafe3 Victory2019.jpg',
			title = 'Players',
			link = 'Portal:Players',
			count = {
				method = 'LPDB',
		...
		{
			file = 'Cozje bmblbe Victory2019.jpg',
			title = 'Tournaments',
		...
		{
			file = 'Battalion-1944-epic-lan-team-leisure-4.png',
			title = 'Transfers',
		...
		{
			file = 'Battalion-1944-epic-lan-team-leisure-1.png',
			title = 'Statistics',
