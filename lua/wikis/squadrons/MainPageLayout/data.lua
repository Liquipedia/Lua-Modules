...
return {
	banner = {
		lightmode = 'Star Wars Squadrons full allmode.png',
		darkmode = 'Star Wars Squadrons full allmode.png',
	},
	metadesc = 'Comprehensive Star Wars: Squadrons wiki with articles covering everything from ships, maps, ' ..
	...
	navigation = {
		...
		{
			file = 'SWS_Starfighter_A-wing.jpg',
			title = 'Ships',
			link = 'Portal:Ships',
		},
		{
