...
return {
	banner = {
		lightmode = 'Clash of Clans_default_lightmode.svg',
		darkmode = 'Clash of Clans_default_darkmode.svg',
	},
	metadesc = 'Comprehensive Clash of Clans wiki with articles covering everything from buildings, to strategies, '..
		'to tournaments, to competitive players and teams.',
	title = 'Clash of Clans',
	navigation = {
		{
			file = 'Synchronic Gaming at Superfest_2024.jpg',
			title = 'Teams',
			link = 'Portal:Teams',
			count = {
				method = 'LPDB',
		...
		{
			file = 'MCES at Clash of Clans World Championship 2019.jpg',
			title = 'Players',
			link = 'Portal:Players',
			count = {
				method = 'LPDB',
		...
		{
			file = 'Clash of Clans World Championship Trophy.jpg',
			title = 'Tournaments',
		...
		{
			file = 'Clash_of_Clans_Wallpaper_1.jpg',
			title = 'Transfers',
		...
		{
			file = 'Clash_of_Clans_Wallpaper_2.jpg',
			title = 'Statistics',
