...
local function SquadPlayer(props, context)
	...
	return Row{
		children = {
			...
			addColumn('teamIcon', otherTeamInformation(squadPlayer.leavedate or squadPlayer.inactivedate, squadPlayer.extradata.loanedto, squadPlayer.extradata.loanedtorole)),
			...
			addColumn('activeteam', otherTeamInformation(squadPlayer.inactivedate, squadPlayer.extradata.activeteam, squadPlayer.extradata.activeteamrole)),
