...
---@class FilterableMatchTickerContainer: Widget
---@operator call(table): FilterableMatchTickerContainer
local FilterableMatchTickerContainer = Class.new(Widget)
FilterableMatchTickerContainer.defaultProps = {
	limit = 10,
...
---@return Widget
function FilterableMatchTickerContainer:render()
...
return FilterableMatchTickerContainer
