---
-- @Liquipedia
-- page=Module:Components/Squad/Header
--
...
local function SquadHeader(props, context)
	...
	local roleTitle = Context.read(context, SquadContexts.RoleTitle)
	local role = show('role') and {TableWidgets.CellHeader{children = {roleTitle}}} or nil
