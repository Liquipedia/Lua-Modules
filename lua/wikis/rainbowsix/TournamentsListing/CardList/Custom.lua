...
---@class RainbowsixTournamentsListing: BaseTournamentsListing
---@operator call(...): RainbowsixTournamentsListing
...
function CustomTournamentsListing.run(frame)
	...
	args.showTier = Logic.nilOr(Logic.readBoolOrNil(args.showTier), true)
	args.showGameIcon = true
	args.useParent = false
	args.onlyTierTypeIfBoth = false
