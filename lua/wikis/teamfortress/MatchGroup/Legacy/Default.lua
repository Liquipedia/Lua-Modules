...
---@class TeamFortressMatchGroupLegacyDefault: MatchGroupLegacy
---@operator call(Frame): TeamFortressMatchGroupLegacyDefault
...
function MatchGroupLegacyDefault:getMap()
	return {
		...
		map = 'map$1$map',
		score1 = 'map$1$team1score',
		score2 = 'map$1$team2score',
		winner = 'map$1$winner',
		logstf = 'logstf$1$',
		logstfgold = 'logstf$1$gold',
		vod = 'vodgame$1$'
	}
end
