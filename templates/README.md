Currently, this folder only contains a list of commons based Templates that is used to protectect templates against creation on the wikis via a git action.
